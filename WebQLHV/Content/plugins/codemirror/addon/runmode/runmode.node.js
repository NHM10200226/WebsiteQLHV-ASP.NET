...
require.cache[require.resolve("~/Content/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/Content/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/Content/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/Content/lib/codemirror"], mod); }
